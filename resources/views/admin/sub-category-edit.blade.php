            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <form id="CategoryForm" enctype="multipart/form-data">
                        <div class="form-wrap">
                            <input type="hidden" name="sub_category_id" id="sub_category_id" value="{{ $sub_category->id }}">
                            {{ csrf_field() }}
                            <h6 class="txt-dark capitalize-font"><i class="icon-list mr-10"></i>About Sub Category</h6>
                            <hr>
                            <div class="row">
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="name" value="{{ $sub_category->name }}" required type="text" placeholder="Enter Sub Category name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="restaurant_id" class="form-control selectpicker btn-outline-none" data-style="btn-default btn-outline">
                                            ...
                                            <option value="{{ $restaurant->id }}" {{ $sub_category->restaurant_id = $restaurant->id ? "selected" :"" }}>{{ $restaurant->name }}</option>
                                            @empty
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="img-upload-wrap">
                                        <div id="imagePreview">
                                            <img src="{{ url('/image/sub_category/'.$sub_category->image) }}" width="80">
                                        </div>
