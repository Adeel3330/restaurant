                    ...
                    <form id="CategoryForm" enctype="multipart/form-data">
                        <div class="form-wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Adddon Sub Category Name</label>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-warning" onclick="window.location.assign('/admin/addon-sub-categories')">Cancel</button>
...
<script>
    $("#CategoryForm").on("submit", function(e) {
        ...
        // console.log(form);
        $.ajax({
            url: "/admin/addon_sub_category_create",
            method: "POST",
            data: formData,
