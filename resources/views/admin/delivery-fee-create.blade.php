                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Free Delivery" name="free_delivery" id="free_delivery" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Basic Delivery Charge</label>
                                        <input type="number" class="form-control" placeholder="Basic Delivery Charge" name="basic_delivery_charge" id="charge_per_kilo" required>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Charge Per Kilo" name="charge_per_kilo" id="charge_per_kilo" required>
                                    </div>
                                </div>
                            </div>
