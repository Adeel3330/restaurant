                ...
                <div class="panel-body">
                    <form id="CategoryForm" enctype="multipart/form-data">
                        <div class="form-wrap">
                            ...
                            {{ csrf_field() }}
                            <h6 class="txt-dark capitalize-font"><i class="icon-list mr-10"></i>About Addon Category</h6>
                            <hr>
                            <div class="row">
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Addon Category Name</label>
...
<script>
    $("#CategoryForm").on("submit", function(e) {
        ...
        // console.log(form);
        $.ajax({
            url: "/admin/addon_category_create",
            method: "POST",
            data: formData,
